...
namespace AnimeNetCore.Models
{
    public class Post
    {
        ...
        [Required]
        [StringLength(50, ErrorMessage = "The {0} must between {2} and {1} characters long.", MinimumLength = 3)]
        [Display(Name = "Title")]
        public string Title { get; set; }

        [Required]
        [StringLength(250, ErrorMessage = "The {0} must between {2} and {1} characters long.", MinimumLength = 1)]
        [Display(Name = "ShortDescription")]
        public string ShortDescription { get; set; }

        [Required]
        [StringLength(5000, ErrorMessage = "The {0} must between {2} and {1} characters long.", MinimumLength = 1)]
        [Display(Name = "Body")]
        public string Body { get; set; }

        [Required]
        [StringLength(25, ErrorMessage = "The {0} must between {2} and {1} characters long.", MinimumLength = 2)]
        [Display(Name = "Meta")]
    ...
    public class Comment
    {
        ...
        [Required]
        [StringLength(1000, ErrorMessage = "The {0} must between {2} and {1} characters long.", MinimumLength = 1)]
        public string Body { get; set; }
